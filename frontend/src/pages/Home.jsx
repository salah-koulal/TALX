  ...
  return (
    <div className="w-full px-20 lg:px-10 pb-20 2xl:px-40 bg-bgColor  h-screen overflow-hidden">
      ...
      <div className="w-full flex gap-2 lg:gap-4 pt-5 pb-10 h-full">
        ...
        {/* CENTER */}
        <div className="flex-1 h-full bg-primary px-4 flex flex-col gap-6 overflow-y-scroll"></div>
              ...
              {friendRequest?.map(({ _id, requestFrom: from }) => (
                <div key={_id} className="flex items-center justify-between">
                  ...
                  <div className="flex gap-1">
                    <CustomButton
                      title="Accept"
                      containerStyles="bg-[#0093f4] text-xs text-white px-1.5 py-1 rounded-full"
                    />
                    <CustomButton
                      title="Deny"
